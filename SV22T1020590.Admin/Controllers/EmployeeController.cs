...
using HrEmployee = SV22T1020590.Models.HR.Employee;
...
namespace SV22T1020590.Admin.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> SaveData(HrEmployee data, IFormFile? uploadPhoto)
        {
            try
            {
                if (data == null)
                {
                    ...
                    return View("Edit", new HrEmployee { EmployeeID = 0, IsWorking = true });
                }
            ...
            catch
            {
                ...
                return View("Edit", data ?? new HrEmployee { EmployeeID = 0, IsWorking = true });
            }
        }
